...
function Strategy(options, verify) {
  ...
  options.tokenURL =  options.tokenURL || 'https://www.trylately.com/v1/apps/oauth/token';
  options.authorizationURL = options.authorizationURL || 'https://www.trylately.com/v1/apps/oauth/authorize';

  OAuth2Strategy.call(this, options, verify);
  this.name = 'Lately';
  this._serverURL = options.serverURL || 'https://www.trylately.com';
  this._userProfileURL = options.profileURL || 'https://www.trylately.com/v1/apps/user/profile';
